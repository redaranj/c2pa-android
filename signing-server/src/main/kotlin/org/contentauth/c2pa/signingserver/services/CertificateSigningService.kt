...
class CertificateSigningService {
    ...
    init {
        ...
        val rootSubject =
            X500Name("CN=C2PA Test Root CA, O=C2PA Signing Server, OU=Certificate Authority, C=US, ST=California, L=San Francisco")
        ...
        val intermediateSubject =
            X500Name("CN=C2PA Test Intermediate CA, O=C2PA Signing Server, OU=Certificate Authority, C=US, ST=California, L=San Francisco")
