...
object CertificateManager {
     ...
     *
     * This is the Android equivalent of iOS's Secure Enclave CSR generation. Android's advantage:
     * We can use standard BouncyCastle APIs since Android allows signing operations with
     * hardware-backed keys through the KeyStore API.
     */
    @JvmStatic
     ...
     * security module, similar to iOS's Secure Enclave
     */
    @JvmStatic
    ...
    @JvmStatic
    fun generateHardwareKey(keyAlias: String, requireStrongBox: Boolean = false): KeyPair {
                ...
                KeyGenParameterSpec.Builder(
                        ...
                        .apply {
                            ...
                            setCertificateNotAfter(
                                    java.util.Date(System.currentTimeMillis() + 86400000L * 365)
                            )
